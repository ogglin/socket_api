...
let CompanyesComponent = class CompanyesComponent {
    constructor(sIO, json) {
        this.sIO = sIO;
        this.json = json;
        ...
        this.ioConnection = this.sIO.onMessage()
            ...
            this.json.toJSON(message).subscribe(data => {
                if (data['companies']) {
                    ...
                    this.filtered = this.companyControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(value => this._filterCompany(value)));
                }
                if (data['putCompany']) {
...
CompanyesComponent.ctorParameters = () => [
...
DateIntervalComponent.ctorParameters = () => [
...
let DeviceManageComponent = class DeviceManageComponent {
    constructor(sIO, json) {
        this.sIO = sIO;
        this.json = json;
        this.devices = [];
...
DeviceManageComponent.ctorParameters = () => [
    { type: _shared_socket_socket_service__WEBPACK_IMPORTED_MODULE_2__["SocketService"] },
        ...
        this.ioConnection = this.sIO.onMessage()
            ...
            this.json.toJSON(message).subscribe(data => {
                if (data['offices']) {
                    ...
                    this.filtered = this.officeControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(value => this._filter(value)));
                }
                if (data['putOffice']) {
...
let AdminComponent = class AdminComponent {
    ...
    ngOnInit() {
        ...
        this.getCustomer();
        this.filteredCustomers = this.customerControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(value => this._filterCustomer(value)));
        this.filteredDevice = this.deviceControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(value => this._filterDevice(value)));
    }
...
let DevicesComponent = class DevicesComponent {
    ...
    ngOnInit() {
        ...
        this.filteredCustomers = this.customerControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(value => this._filterCustomer(value)));
        this.filteredDevice = this.deviceControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(value => this._filterDevice(value)));
    }
    _filterDevice(value) {
        const filterValue = value.toLowerCase();
        return this.filteredPlacement.filter(option => option.toLowerCase().includes(filterValue));
...
let ToXlsxService = class ToXlsxService {
    ...
    saveAsExcelFile(buffer, fileName) {
        ...
        const m = (parseInt(String(new Date().getMonth() + 1)));
    ...
    setId(e) {
        switch (e.init) {
            case "company":
                ...
                setTimeout(() => { this.cid = e.id; }, 10);
                break;
            case "office":
                this.oid = null;
                this.did = null;
                setTimeout(() => { this.oid = e.id; this.office = e.office; }, 10);
                break;
            case "device":
                this.did = null;
                setTimeout(() => { this.did = e.id; }, 10);
                break;
        }
    }
    go(url) {
